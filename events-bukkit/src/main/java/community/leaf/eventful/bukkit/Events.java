...
{
    /**
     * Creates a new {@code Events} instance by resolving plugin classes on the current call stack.
     * The first plugin found on the call stack will be used for event registration.
     *
     * <p><b>Note:</b> a stacktrace will be generated every time this method is invoked, so consider
     * reusing instances rather than constantly re-resolving them.</p>
     *
     * @return a new instance that registers events with the plugin resolved from the current call stack
     */
    ...
    /**
     * Registers the provided event consumer at {@code NORMAL} priority, accepting all events whether cancelled or not.
     *
     * @param event     the event type
     * @param listener  the event handler
     * @param <E>       event type
    ...
    interface Builder<E extends Event>
    {
        ...
        /**
         * Sets the priority to {@link ListenerOrder#FIRST}, which gets called first.
         *
         * @return the builder (for method chaining)
         */
        ...
        /**
         * Sets the priority to {@link ListenerOrder#EARLY}, which gets called earlier than most other priorities.
         *
         * @return the builder (for method chaining)
         */
        ...
        /**
         * Sets the priority to {@link ListenerOrder#NORMAL}, which is the default priority for event listeners.
         *
         * @return the builder (for method chaining)
         */
        ...
        /**
         * Sets the priority to {@link ListenerOrder#LATE}, which gets called after most other priorities.
         *
         * @return the builder (for method chaining)
         */
        ...
        /**
         * Sets the priority to {@link ListenerOrder#LAST}, which gets called last.
         *
         * @return the builder (for method chaining)
         */
        ...
        /**
         * Sets the priority to {@link ListenerOrder#MONITOR}, which <i>truly</i> gets called last (because it's meant
